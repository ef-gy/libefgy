...
public:
  ...
  constexpr static Q raise(const Q &base) {
    return (exponent % 2 == 0)
               ...
               : (base *
                  integral<Q, ((exponent - 1) >> 1)>::raise(base * base));
  }
};
...
public:
   ...
   *         to the caller.
   */
  constexpr static Q raise(const Q &base) { return base; }
};
...
public:
   ...
   */
  constexpr static Q raise(const Q &base) { return Q(1) / base; }
};
...
public:
   ...
   * \return Always Q(1).
   */
  constexpr static Q raise(const Q &base) { return Q(1); }
